...
# 📊 Power BI Hospital & Healthcare Dashboard (Excel Data)

This project showcases a **modern and interactive Power BI dashboard** developed using structured healthcare datasets.  
The dashboard provides meaningful insights by visualizing **patient volume, recovery trends, department-wise distribution, bed usage, and age-group analysis**.
